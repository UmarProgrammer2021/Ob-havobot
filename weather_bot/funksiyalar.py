...
def start(update, context):
	...
	update.message.reply_html('Assalomu Aleykum <b>{}</b> 🤝. uzbweather_bot ga xush kelibsiz !!! \n  \nSizga foydamiz tegganidan xursandmiz😊. Iltimos hududni tanlang:'.format(user.first_name), reply_markup=hududlar_button)
...
def toshkent(update, context):
	...
	update.message.reply_text("Buxoro belgilandi. Bugun Toshkent ob-havo 🌦👇:"+ '\n' + "Eng past daraja⬇️ :" + t_min +','+ '\n' + "Eng yuqori daraja⬆️ :"+ t_max, reply_markup = hududlar_button)
...
def help_command(update,context):
    update.message.reply_text("Yordam uchun @developeryuldashev ga murojaat qiling .")


def admin(update,context):
    update.message.reply_text("Admin👨🏻‍💻 bilan bog'lanish - @developeryuldashev ")